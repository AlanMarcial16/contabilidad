...
<body>
    <div class="login">
        ...
        <h1 class="login-header">CONTABILIDAD</h1>
        <br>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="login-container">
            ...
            <p><a href="../inventario/index.php">Necesitas acceder al Almacén? Haz click Aquí!</a></p>
            <p><a href="register.php">Registrar usuario</a></p>
        </form>
    </div>
    <br>    
</body>
